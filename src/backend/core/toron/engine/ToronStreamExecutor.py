...
class ToronStreamExecutor:
    """Streaming execution path leveraging the Nexus Engine callbacks."""
    ...
    async def execute(
        ...
        *,
        ...
        result = await self.engine.run_async_streaming(
