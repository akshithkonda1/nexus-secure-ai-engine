...
function Placeholder({
  ...
  return (
    <div className="mx-auto flex min-h-[50vh] max-w-3xl flex-col items-center justify-center rounded-3xl border border-app bg-panel p-12 text-center text-muted shadow-2xl">
