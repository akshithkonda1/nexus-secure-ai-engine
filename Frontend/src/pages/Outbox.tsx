...
export function Outbox() {
  ...
  return (
    <div className="space-y-8">
      <header className="panel panel--glassy panel--hover panel--immersive panel--edge panel--halo panel--alive flex flex-col gap-4 rounded-[28px] border border-[rgba(var(--border),0.7)] bg-white/80 p-6 shadow-[var(--shadow-soft)] dark:bg-[rgba(var(--panel),0.7)]">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="btn btn-ghost btn-quiet inline-flex items-center gap-2 rounded-full border border-[rgba(var(--border),0.7)] bg-white/80 px-5 py-2 text-sm font-semibold text-[rgb(var(--text))] transition hover:bg-[rgba(var(--panel),0.7)]"
            >
              Browse templates
            </button>
          </div>
      ...
      <section className="grid gap-6 lg:grid-cols-[2fr,1fr]">
        <div className="panel panel--glassy panel--hover panel--immersive panel--alive rounded-[26px] border border-[rgba(var(--border),0.7)] bg-white/85 p-6 shadow-[var(--shadow-soft)] dark:bg-[rgba(var(--panel),0.7)]">
        ...
        <div className="panel panel--glassy panel--hover panel--immersive panel--alive flex flex-col gap-4 rounded-[26px] border border-[rgba(var(--border),0.7)] bg-white/85 p-6 shadow-[var(--shadow-soft)] dark:bg-[rgba(var(--panel),0.7)]">
          <div>
          ...
          <ul className="space-y-3 text-sm">
            {templates.map((template) => (
              <li key={template.id} className="panel panel--glassy panel--hover panel--immersive panel--alive rounded-2xl border border-[rgba(var(--border),0.6)] bg-[rgba(var(--panel),0.65)] p-4">
                ...
                <button
                  ...
                  className="btn btn-ghost btn-quiet mt-3 inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.22em] text-brand"
                >
          ...
          <div className="panel panel--glassy panel--hover panel--immersive panel--alive mt-auto rounded-2xl border border-[rgba(var(--border),0.6)] bg-[rgba(var(--panel),0.65)] p-4 text-sm text-[rgb(var(--text))]">
            ...
            <button
              ...
              className="btn btn-ghost btn-quiet mt-3 inline-flex items-center gap-2 rounded-full border border-[rgba(var(--border),0.6)] px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em] text-brand"
            >
      ...
      <section className="panel panel--glassy panel--hover panel--immersive panel--alive rounded-[26px] border border-[rgba(var(--border),0.7)] bg-white/85 p-6 shadow-[var(--shadow-soft)] dark:bg-[rgba(var(--panel),0.7)]">
        <header className="flex items-center justify-between">
          <div>
