...
export function Governance() {
  return (
    <div className="space-y-8">
      <header className="panel panel--glassy panel--hover panel--immersive panel--edge panel--halo panel--alive halo panel--hover panel--glow panel--gradient-border rounded-[28px] border border-[rgba(var(--border),0.7)] bg-[rgba(var(--surface),0.8)] p-6 shadow-[var(--shadow-soft)]">
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <div className="panel panel--glassy panel--hover panel--immersive panel--alive panel--hover panel--glow panel--gradient-border rounded-[24px] border border-[rgba(var(--border),0.7)] bg-[rgba(var(--surface),0.85)] p-5 shadow-[var(--shadow-soft)]">
      ...
      <section className="panel panel--glassy panel--hover panel--immersive panel--alive panel--hover panel--glow panel--gradient-border rounded-[26px] border border-[rgba(var(--border),0.7)] bg-[rgba(var(--surface),0.85)] p-6 shadow-[var(--shadow-soft)]">
      ...
      <section className="panel panel--glassy panel--hover panel--immersive panel--alive panel--glow rounded-[26px] border border-[rgba(var(--border),0.7)] bg-[rgba(var(--surface),0.85)] p-6 shadow-[var(--shadow-soft)]">
