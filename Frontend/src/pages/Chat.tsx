...
export function Chat() {
  ...
  return (
    <section className="flex h-full flex-col gap-6">
      <header className="panel panel--glassy panel--hover panel--immersive panel--alive rounded-2xl bg-[rgb(var(--panel))] px-6 py-4 shadow-[var(--elev-1)]">
        ...
        <div className="h-full overflow-y-auto p-6">
          <div className="space-y-4">
            {messages.map((message) => (
              <article
                key={message.id}
                className={`panel panel--glassy panel--hover panel--immersive panel--alive rounded-2xl border border-[color:rgba(var(--border))] bg-[rgb(var(--panel))] px-5 py-4 shadow-sm ${
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="btn btn-ghost btn-quiet rounded-full border border-[color:rgba(var(--border))] px-4 py-2 text-sm text-[rgb(var(--text))] transition hover:bg-[rgb(var(--panel))]"
            >
              Attach files
            </button>
            {pendingAttachments.length > 0 && (
