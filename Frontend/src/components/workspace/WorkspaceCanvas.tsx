...
const WorkspaceCanvas: React.FC<WorkspaceCanvasProps> = ({ mode }) => {
  return (
    <div className="relative flex-1 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl overflow-hidden shadow-2xl">
      ...
      <div className="relative h-full flex items-center justify-center p-10 text-center">
        {mode ? (
          <div className="text-white/70 text-lg">{`Focused on ${mode} workspace`}</div>
        ) : (
          <div className="space-y-3 max-w-xl">
            <div className="text-2xl font-semibold text-white">Ryuzen Workspace Canvas</div>
