    ...
    <div className="space-y-4 leading-relaxed text-neutral-800 dark:text-neutral-200">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {["Overview", "Playbooks", "Architecture"].map((page) => (
          <div
            key={page}
            className="relative rounded-3xl bg-white/85 dark:bg-neutral-900/85 border border-neutral-300/50 dark:border-neutral-700/50 text-neutral-800 dark:text-neutral-200 shadow-[0_4px_20px_rgba(0,0,0,0.12)] backdrop-blur-xl p-6 md:p-8 z-[10]"
          >
