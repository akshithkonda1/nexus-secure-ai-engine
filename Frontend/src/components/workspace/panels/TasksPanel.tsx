...
const statusColors: Record<string, string> = {
  Todo: 'bg-white/10 border-white/20 text-white',
    ...
    <div className="space-y-6 text-white">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-white/70">Track task status and linked lists.</p>
        </div>
        <button className="px-4 py-2 rounded-2xl bg-white/10 border border-white/20 hover:bg-white/15">Add Task</button>
      </div>
        ...
        {tasks.map((task) => (
          ...
          >
            <div>
              ...
              <div className="text-white/60 text-sm">Linked to {task.list}</div>
            </div>
