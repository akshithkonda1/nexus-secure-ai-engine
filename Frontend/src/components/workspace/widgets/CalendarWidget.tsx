...
const CalendarWidget: React.FC<CalendarWidgetProps> = ({ active, onClick }) => {
  return (
    <motion.button
      whileHover={{ y: -2 }}
      whileTap={{ scale: 0.98 }}
    ...
    >
      <div>
        <div className="text-xs uppercase tracking-[0.2em] text-textPrimary/60">Calendar</div>
        <div className="font-semibold text-textPrimary">Plan the day</div>
      </div>
