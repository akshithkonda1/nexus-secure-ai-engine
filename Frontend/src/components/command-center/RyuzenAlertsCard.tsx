    ...
    <div className="card-aurora p-4 lg:p-5 text-textPrimary/90">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h3 className="text-lg font-semibold text-textPrimary">Ryuzen Alerts</h3>
        </div>
      ...
      <ul className="mt-4 space-y-3">
        {alerts.map((alert) => (
          <li
            key={alert}
            className="flex items-start gap-3 rounded-2xl border border-borderLight/5 bg-bgPrimary/5 p-3 text-sm text-textMuted"
          >
