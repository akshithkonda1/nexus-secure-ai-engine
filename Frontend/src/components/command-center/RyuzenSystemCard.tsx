    ...
    <div className="card-aurora p-4 lg:p-5 text-textPrimary/90">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h3 className="text-lg font-semibold text-textPrimary">Ryuzen Status</h3>
        </div>
      ...
      <div className="mt-4 space-y-3">
        <div>
          ...
          <div className="mt-2 h-2.5 w-full overflow-hidden rounded-full bg-bgPrimary/5">
            <div className="progress-flowline h-full w-[92%] shadow-[0_0_24px_rgba(56,189,248,0.45)]" />
          </div>
        </div>

        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-2xl border border-borderLight/10 bg-bgPrimary/5 p-3">
            <p className="text-xs text-textMuted">Context Depth</p>
            <p className="text-lg font-semibold text-textPrimary">64K tokens</p>
          </div>
          <div className="rounded-2xl border border-borderLight/10 bg-bgPrimary/5 p-3">
            <p className="text-xs text-textMuted">Signal Health</p>
