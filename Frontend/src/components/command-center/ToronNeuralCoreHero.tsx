...
export function ToronNeuralCoreHero() {
  return (
    <div className="card-aurora relative overflow-hidden p-6 text-white/90">
      ...
      <div className="relative flex flex-col items-center gap-4 text-center">
        <div className="relative mt-2 h-56 w-56">
          ...
          <div className="absolute inset-[18%] animate-[pulse_3.6s_ease-in-out_infinite] rounded-full border border-white/10" />
        ...
        <div className="space-y-1">
          ...
          <h3 className="text-2xl font-semibold text-white">Toron Horizon v1.6</h3>
          <p className="text-sm text-slate-200">Active Models: GPT-5, Sonnet, Qwen, DeepSeek</p>
