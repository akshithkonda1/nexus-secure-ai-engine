...
export function DataTransformerCard() {
  return (
    <div className="card-aurora relative overflow-hidden p-4 lg:p-5 text-white/90">
      ...
      <div className="relative flex items-center justify-between">
        <div>
          ...
          <h3 className="text-lg font-semibold text-white">Data Transformer</h3>
        </div>
      ...
      <div className="relative mt-4">
        <div className="h-28 overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-4">
