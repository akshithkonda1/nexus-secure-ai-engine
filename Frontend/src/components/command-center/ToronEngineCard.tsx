...
export function ToronEngineCard() {
  return (
    <div className="card-aurora p-4 lg:p-5 text-textPrimary/90 relative overflow-hidden">
      ...
      <div className="relative flex items-center justify-between">
        <div>
          ...
          <h3 className="text-lg font-semibold text-textPrimary">Neural Load</h3>
        </div>
      ...
      <div className="relative mt-4 flex items-center gap-4">
        <div className="flex-1 space-y-2">
          ...
          <div className="h-2.5 rounded-full bg-bgPrimary/5 overflow-hidden">
            <div className="h-full w-[68%] bg-gradient-to-r from-cyan-400 via-sky-500 to-indigo-500 shadow-[0_0_20px_rgba(56,189,248,0.45)]" />
          </div>
          <p className="text-xs text-textMuted">Adaptive cadence engaged. Thermal safe.</p>
        </div>
        <div className="rounded-2xl border border-borderLight/10 bg-bgPrimary/5 p-3 text-center min-w-[120px]">
          <p className="text-xs text-textMuted">Active models</p>
          <p className="text-2xl font-semibold text-textPrimary">4</p>
          <p className="text-[11px] text-textMuted">Heterogeneous routing</p>
        </div>
      </div>
    </div>
  );
