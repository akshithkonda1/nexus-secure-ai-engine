...
export default function AppShell({ children, rightRail }: AppShellProps) {
  return (
    <div className="flex h-screen w-full overflow-hidden bg-[#FAFAFA] text-gray-900 transition-colors">
      {/* Main Layout */}
      <div className="flex h-full w-full">
        ...
        {/* Right Rail */}
        {rightRail && (
          <aside className="hidden w-80 shrink-0 border-l border-gray-200 bg-white xl:block">
